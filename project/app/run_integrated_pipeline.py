...
R8 uses Groq and Gemini APIs by default.
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default="all",
        help="AI provider used by R8 (default: both)",
    )
    parser.add_argument(
        "--r8-mode",
        choices=["api"],
    ...
    try:
        ...
        heading(6, total, "R8 — synthesize R3/R4/R5 with Groq and Gemini")
