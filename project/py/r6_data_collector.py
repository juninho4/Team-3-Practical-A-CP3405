...
Custom output path:
    python r6_data_collector.py --output C:/my_project/output/evidence/my_actuals.csv
...
def default_evidence_directory() -> Path:
    return project_root() / "output" / "evidence"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Evidence directory; default: project/output/evidence",
    )
    parser.add_argument(
        "--output",
        type=Path,
        help="Optional CSV path; default: project/output/evidence/r6_market_actuals_YYYY-WXX.csv",
    )
    parser.add_argument(
        "--workers",
        type=int,
