...
TARGET_LAST_TRADING_DATE = "2026-07-24"
DOWNLOAD_START_DATE = "2025-07-23"
DOWNLOAD_END_DATE = "2026-07-24"  # yfinance end date is exclusive
...
CSV_OUTPUT = "technical_agent_output_W30.csv"
JSON_OUTPUT = "technical_agent_output_W30.json"
...
def clean_downloaded_data(data):
    ...
    # Keep only data up to 2026-07-24
